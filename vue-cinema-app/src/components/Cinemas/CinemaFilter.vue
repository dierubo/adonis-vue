...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapMutations({ // Esto nos va a servir para cambiar el valor de la búsqueda, de las salas, de los asientos y limpiar los filtros 
        ...
        computed: {
            ...
            search: {
                get () {
                    return this.query; // este datos es el query que está dentro de mapGetters
                },
                set (value) {
